...
void driveSet(int left, int right) {
  ...
  blrsMotorSet(DRIVE_LEFT_2, left, false);
  blrsMotorSet(DRIVE_RIGHT, right, false);
  blrsMotorSet(DRIVE_RIGHT_2, right, false);
}

void driveInit() {
  blrsMotorInit(DRIVE_LEFT, true, 0.5f, NULL);
  blrsMotorInit(DRIVE_LEFT_2, false, 0.5f, NULL);
  blrsMotorInit(DRIVE_RIGHT, true, 0.5f, NULL);
  blrsMotorInit(DRIVE_RIGHT_2, false, 0.5f, NULL);
